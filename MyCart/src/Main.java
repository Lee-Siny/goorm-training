...
//  HashSet을 사용하여 상품 목록을 만들고, HashMap을 사용하여 장바구니에 상품을 담음
//
//  구현하기 위해서는 다음과 같은 클래스가 필요
//
//  - 상품
//  - 상품의 key, 이름, 가격을 필드로 가지고 있음
//  - equals() 및 hashCode() 함수를 override 해야함. HashSet을 사용할때 중복된 상품이 상품목록에 들어가지 않게 이 함수들이 사용되어야 함
//
...
//  - removeProduct()
//
//  장바구니 어플리케이션은 다음과 같은 기능을 제공해야함
//
//  1. 상품을 입력하여 상품목록을 구성함
//  2. 장바구니에 상품을 담습니다. 이때, 상품을 몇개 담을것인지 또한 명시되어야 함
//  ex. 우유 2개 담기, 사과 1개 담기
//  3. 장바구니에서 상품을 제거합니다. 이때, 몇개의 상품을 뺄것인지 명시되어야 함
//  ex. 우유 1개 빼기
//  4. 장바구니에 담겨있는 상품들의 이름과 수량을 출력해야함
